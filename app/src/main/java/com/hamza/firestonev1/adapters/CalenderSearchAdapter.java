...
public class CalenderSearchAdapter extends FirestoreRecyclerAdapter<Shifts, CalenderSearchAdapter.shiftHolder> {
 Context mContext;
String ShiftID;
    public CalenderSearchAdapter(@NonNull FirestoreRecyclerOptions<Shifts> options, Context mContext) {
        super(options);
        ...
        public shiftHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("ShiftID",id.getText().toString());
